            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Traveler Journey</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<section class="shop-page section-padding-0-100">
    <div class="container">
        <div class="row">
            ...
            ?>
                <div class="col-md-12 mb-3" flex; justify-content: center>
                    <div class="card">
                        <div class="card-body">
                            <form method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Caption</label>
                                    <textarea class="form-control" rows="5" id="caption" name="caption" required></textarea>
                                    <script>
                                        CKEDITOR.replace('icaptionsi');
                                    </script>
                                </div>
                                <div class="form-group">
                                    <label>Foto</label>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn float-right btn-primary" name="posting">Posting</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <?php } ?>
            <div class="col-12 col-md-12 col-lg-12" style="padding-top:50px">
                <h2 class="mb-5">Linimasa Terbaru</h2>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    ?>
                                                        ...
                                                        ?>
                                                        <a href="like.php?idposting=<?= $idposting ?>&jenis=Like"><i class="fa fa-thumbs-up fa-6x thumbs-icon <?= $aktif ?>"><?= $hitunglike ?></i></a>
                                                        &nbsp;
                                                        &nbsp;
                                                        <?php
                                                        ...
                                                        ?>
                                                        <a href="like.php?idposting=<?= $idposting ?>&jenis=Dislike"><i class="fa fa-thumbs-down fa-6x thumbs-icon <?= $aktif ?>"><?= $hitungdislike ?></i></a>
                                                    <?php } else { ?>

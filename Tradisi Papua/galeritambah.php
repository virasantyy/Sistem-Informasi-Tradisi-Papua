							...
							<div class="col-md-12">
								<form method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<input type="text" required class="form-control" name="galeri">
									</div>
									<div class="form-group">
...
if (isset($_POST['tambah'])) {
	...
	$galeri = $_POST["galeri"];
	$koneksi->query("INSERT INTO galeri(namagaleri,fotogaleri)
		VALUES ('$galeri','$namafoto')");
	echo "<script> alert('Galeri Berhasil Di Tambah');</script>";
